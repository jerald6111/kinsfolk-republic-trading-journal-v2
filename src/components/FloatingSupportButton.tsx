  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 left-6 bg-gradient-to-r from-krgold to-kryellow text-krblack px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all flex items-center gap-2 z-40 ${
